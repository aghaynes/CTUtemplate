...
`r badger::badge_custom("dev version", as.character(packageVersion("CTUtemplate")), "blue", "https://github.com/dcr-unibe-ch/CTUtemplate")`
...
See also the [quarto template repo](https://github.com/dcr-unibe-ch/quarto) for more info on our quarto templates. 
